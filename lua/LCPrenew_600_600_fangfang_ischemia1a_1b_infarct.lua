...
parsedTissue.stimulate.s1_1 = makeStimulate(parsedTissue, 20, -120, 0, 3,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
								   else return false end
								end

)
parsedTissue.stimulate.s1_1_2 = makeStimulate(parsedTissue, 40, -120, 0, 3,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_1_3 = makeStimulate(parsedTissue, 64, -120, 0, 3,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_2 = makeStimulate(parsedTissue, 20, -120, 1000, 1003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_2_2 = makeStimulate(parsedTissue, 40, -120, 1000, 1003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_2_3 = makeStimulate(parsedTissue, 64, -120, 1000, 1003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_3 = makeStimulate(parsedTissue, 20, -120, 2000, 2003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_3_2 = makeStimulate(parsedTissue, 40, -120, 2000, 2003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_3_3 = makeStimulate(parsedTissue, 64, -120, 2000, 2003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_4 = makeStimulate(parsedTissue, 20, -120, 3000, 3003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_4_2 = makeStimulate(parsedTissue, 40, -120, 3000, 3003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_4_3 = makeStimulate(parsedTissue, 64, -120, 3000, 3003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_5 = makeStimulate(parsedTissue, 20, -120, 4000, 4003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_5_2 = makeStimulate(parsedTissue, 40, -120, 4000, 4003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s1_5_3 = makeStimulate(parsedTissue, 64, -120, 4000, 4003,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								  if x<=3  then return true  --if x>160 and x < 170 and y>230 and y<240   liang_change
...
parsedTissue.stimulate.s2_2 = makeStimulate(parsedTissue, 20, -120, 4370, 4373,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								   if y>=300 and y <=600 and x>=0 and x<=300  then return true   --x < 50   liang_change
								   else return false end
								end

)
parsedTissue.stimulate.s2_3 = makeStimulate(parsedTissue, 40, -120,4370, 4373,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								   if y>=300 and y <=600 and x>=0 and x<=300    then return true   --x < 50   liang_change
...
parsedTissue.stimulate.s2_4 = makeStimulate(parsedTissue, 64, -120,4370, 4373,
								function(x,y,z)--对所有在下面园中的22细胞加刺激
								   --balls = {{0,0,0,80}}
								   --return pointInBalls(balls, x,y,z)
								   if y>=300 and y <=600 and x>=0 and x<=300   then return true   --x < 50   liang_change
...
for step = startStep, endStep do
   ...
   --写数据
   if step % 500 == 0 then --step>900*4*50 
	  newTime = os.time()
